...
var Router = function (_React$Component) {
  ...
  Router.prototype.componentWillMount = function componentWillMount() {
    ...
    this.unlisten = history$$1.listen(function () {
      _this2.setState({
        match: _this2.computeMatch(history$$1.location.pathname)
      });
    });
  };
...
var MemoryRouter = function (_React$Component) {
  ...
  function MemoryRouter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn$1(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.history = history.createMemoryHistory(_this.props), _temp), _possibleConstructorReturn$1(_this, _ret);
  }
...
var Route = function (_React$Component) {
  ...
  Route.prototype.render = function render() {
    ...
    var _context$router = this.context.router,
        history$$1 = _context$router.history,
...
var StaticRouter = function (_React$Component) {
  ...
  StaticRouter.prototype.render = function render() {
    ...
    return React.createElement(Router, _extends$3({}, props, { history: history$$1 }));
  };
...
var createConnectRouter = function createConnectRouter(structure) {
  ...
  var createRouterReducer = function createRouterReducer(history$$1) {
 ...
 */
var routerMiddleware = function routerMiddleware(history$$1) {
...
var successAction = function successAction(action, data) {
  return _extends_1({}, isFSA(action) ? {
    payload: {
      data: data
    }
  } : {
    ...
    meta: _extends_1({}, action.meta, {
      requestAction: action
    })
  });
};
var errorAction = function errorAction(action, errorData) {
  return _extends_1({}, isFSA(action) ? {
    payload: errorData,
    error: true
  } : {
...
var abortAction = function abortAction(action) {
  return {
    meta: _extends_1({}, action.meta, {
      requestAction: action
    })
...
var isRequestAction = function isRequestAction(action) {
  ...
  return !!actionPayload && !!actionPayload.request && !!(Array.isArray(actionPayload.request) || actionPayload.request.url) && !actionPayload.response && !(actionPayload instanceof Error);
};

var shouldActionBePromisified = function shouldActionBePromisified(action, auto) {
  return auto || action.meta && action.meta.asPromise;
};
...
var requestsPromiseMiddleware = function requestsPromiseMiddleware(_temp) {
  var _ref = _temp === void 0 ? {} : _temp,
      ...
      _ref$getRequestAction = _ref.getRequestAction,
      getRequestAction = _ref$getRequestAction === void 0 ? function (action) {
    return action.meta && action.meta.requestAction ? action.meta.requestAction : null;
  } : _ref$getRequestAction;
    ...
    return function (next) {
      return function (action) {
        if (isRequestAction(action) && shouldActionBePromisified(action, auto)) {
          return new Promise(function (resolve, reject) {
            requestMap.set(action, function (response, error$$1) {
              return error$$1 ? reject(response) : resolve(response);
            });
            next(action);
          });
        }

        var requestAction = getRequestAction(action);

        if (requestAction && shouldActionBePromisified(requestAction, auto)) {
          var requestActionPromise = requestMap.get(requestAction);
          requestActionPromise(action, action.type !== success$$1(requestAction.type));
...
var _marked =
/*#__PURE__*/
regenerator.mark(getRequestInstance),
    _marked2 =
/*#__PURE__*/
regenerator.mark(sendRequest),
    _marked3 =
/*#__PURE__*/
regenerator.mark(cancelSendRequestOnAction),
    _marked4 =
/*#__PURE__*/
regenerator.mark(watchRequests);
var defaultConfig$1 = {
  driver: null,
  success: success,
  error: error,
...
function createRequestInstance(config) {
  ...
  return effects.setContext((_setContext = {}, _setContext[REQUESTS_CONFIG] = _extends_1({}, defaultConfig$1, config), _setContext));
}
function getRequestsConfig() {
  return effects.getContext(REQUESTS_CONFIG);
}
function getRequestInstance(driverType) {
  var config, driver;
  return regenerator.wrap(function getRequestInstance$(_context) {
    while (1) {
...
function sendRequest(action, _temp) {
  var _ref, _ref$dispatchRequestA, dispatchRequestAction, _ref$silent, silent, _ref$runOnRequest, runOnRequest, _ref$runOnSuccess, runOnSuccess, _ref$runOnError, runOnError, _ref$runOnAbort, runOnAbort, requestsConfig, driver, actionPayload, abortSource, response, responseError, _ref2, onErrorResponse, onErrorError, errorPayload, successPayload;

  return regenerator.wrap(function sendRequest$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _ref = _temp === void 0 ? {} : _temp, _ref$dispatchRequestA = _ref.dispatchRequestAction, dispatchRequestAction = _ref$dispatchRequestA === void 0 ? false : _ref$dispatchRequestA, _ref$silent = _ref.silent, silent = _ref$silent === void 0 ? false : _ref$silent, _ref$runOnRequest = _ref.runOnRequest, runOnRequest = _ref$runOnRequest === void 0 ? true : _ref$runOnRequest, _ref$runOnSuccess = _ref.runOnSuccess, runOnSuccess = _ref$runOnSuccess === void 0 ? true : _ref$runOnSuccess, _ref$runOnError = _ref.runOnError, runOnError = _ref$runOnError === void 0 ? true : _ref$runOnError, _ref$runOnAbort = _ref.runOnAbort, runOnAbort = _ref$runOnAbort === void 0 ? true : _ref$runOnAbort;
        ...
        case 9:
          _context2.next = 11;
          return effects.call(getDriver, requestsConfig, action);
        ...
        case 11:
          ...
          _context2.next = 16;
          return effects.call(requestsConfig.onRequest, actionPayload.request, action);
        ...
        case 17:
          ...
          _context2.next = 23;
          return effects.call([driver, 'sendRequest'], actionPayload.request, abortSource, action);
        ...
        case 26:
          _context2.next = 28;
          return effects.all(actionPayload.request.map(function (requestItem) {
            return effects.call([driver, 'sendRequest'], requestItem, abortSource, action);
          }));
        ...
        case 34:
          ...
          _context2.next = 38;
          return effects.call(requestsConfig.onError, responseError, action);
        ...
        case 42:
          ...
          _context2.next = 45;
          return effects.call(driver.getErrorPayload, responseError);
        ...
        case 50:
          ...
          _context2.next = 53;
          return effects.call(requestsConfig.onSuccess, response, action);
        ...
        case 54:
          _context2.next = 56;
          return effects.call(driver.getSuccessPayload, response, actionPayload.request);
        ...
        case 64:
          ...
          _context2.next = 67;
          return effects.call([driver, 'abortRequest'], abortSource);
        ...
        case 67:
          ...
          _context2.next = 70;
          return effects.call(requestsConfig.onAbort, action);
  ...
  }, _marked2, this, [[18,, 61, 74], [19, 31]]);
}

var isGetRequest = function isGetRequest(request) {
  return !request.method || request.method.toLowerCase() === 'get';
};
...
var watchRequestsDefaultConfig = {
  takeLatest: function takeLatest(action) {
    ...
    return Array.isArray(request) ? request.every(isGetRequest) : isGetRequest(request);
  },
  abortOn: null,
...
function cancelSendRequestOnAction(abortOn, task) {
  ...
  return regenerator.wrap(function cancelSendRequestOnAction$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return effects.race({
            abortingAction: effects.take(abortOn),
            taskFinished: effects.join(task),
            timeout: effects.call(createSagaMiddleware.delay, 10000) // taskFinished doesnt work for aborted tasks
...
function watchRequests(common, perRequestType) {
  var lastTasks, config, action, localConfig, lastActionKey, takeLatest, activeTask, newTask;
  return regenerator.wrap(function watchRequests$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          ...
          if (perRequestType === void 0) {
            perRequestType = {};
          }

          lastTasks = {};
          config = _extends_1({}, watchRequestsDefaultConfig, common);

        case 4:

          _context4.next = 7;
          return effects.take(isRequestAction);

        case 7:
          action = _context4.sent;
          localConfig = perRequestType[action.type] ? _extends_1({}, config, perRequestType[action.type]) : config;
          lastActionKey = localConfig.getLastActionKey(action);
          takeLatest = typeof localConfig.takeLatest === 'function' ? localConfig.takeLatest(action) : localConfig.takeLatest;
          ...
          _context4.next = 16;
          return effects.cancel(activeTask);

        case 16:
          _context4.next = 18;
          return effects.fork(sendRequest, action);
        ...
        case 18:
          ...
          _context4.next = 23;
          return effects.fork(cancelSendRequestOnAction, localConfig.abortOn, newTask);
...
var createDriver = function createDriver(fetchInstance, _temp) {
  ...
  return {
    ...
    sendRequest: function () {
      var _sendRequest = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee(_ref2, abortSource) {
        ...
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                url = _ref2.url, _ref2$responseType = _ref2.responseType, responseType = _ref2$responseType === void 0 ? 'json' : _ref2$responseType, requestConfig = objectWithoutPropertiesLoose(_ref2, ["url", "responseType"]);
                _context.next = 3;
                return fetchInstance(isAbsoluteURL(url) ? url : baseURL + url, _extends_1({
...
function configureStore() {
  ...
  var history$$1 = args.history || createBrowserHistory();
  var middlewares = args.middlewares || [];
  var request = args.request || {};
  var reducers = args.reducers || {};

  var initialReducers = objectSpread({
    router: lib_11(history$$1)
  }, reducers);

  var middlewaresToApply = [sagaMiddleware, thunkMiddleware, lib_10(history$$1), requestsPromiseMiddleware({
    auto: Boolean(request.asPromise)
  })].concat(toConsumableArray(middlewares));
  var enhancers = [redux.applyMiddleware.apply(void 0, toConsumableArray(middlewaresToApply))]; // If Redux DevTools Extension is installed use it, otherwise use Redux compose

  /* eslint-disable no-underscore-dangle */

  var composeEnhancers = (typeof window === "undefined" ? "undefined" : _typeof_1(window)) === 'object' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({
  ...
  var store = redux.createStore(redux.combineReducers(initialReducers), {}, composeEnhancers.apply(void 0, enhancers)); // eslint-disable-next-line func-names
    ...
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            _context.next = 4;
            return effects.fork(watchRequests);
  ...
  store.history = history$$1; // history
...
var classCallCheck = _classCallCheck$7;
...
var possibleConstructorReturn = _possibleConstructorReturn$7;
...
function checkStore(store) {
  ...
  invariant_1(conformsTo(store, shape), '(app/utils...) injectors: Expected a valid redux store');
}
...
function injectReducerFactory(store, isValid) {
  return function injectReducer(key, reducer) {
    ...
    invariant_1(isString(key) && !isEmpty(key) && isFunction(reducer), '(app/utils...) injectReducer: Expected `reducer` to be a reducer function'); // Check `store.injectedReducers[key] === reducer` for hot reloading when a key is the same but a reducer is different
...
var injectReducer = (function (_ref) {
  ...
  return function (WrappedComponent) {
    ...
    function (_React$Component) {
      inherits(ReducerInjector, _React$Component);
      ...
      function ReducerInjector() {
        ...
        classCallCheck(this, ReducerInjector);

        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }

        _this = possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf$1(ReducerInjector)).call.apply(_getPrototypeOf2, [this].concat(args)));

        defineProperty(assertThisInitialized(assertThisInitialized(_this)), "injectors", getInjectors(_this.context.store));

        return _this;
      }

      createClass(ReducerInjector, [{
        key: "UNSAFE_componentWillMount",
        value: function UNSAFE_componentWillMount() {
          var injectReducer = this.injectors.injectReducer;
    ...
    defineProperty(ReducerInjector, "displayName", "withReducer(".concat(WrappedComponent.displayName || WrappedComponent.name || 'Component', ")"));

    defineProperty(ReducerInjector, "contextTypes", {
      // eslint-disable-next-line react/forbid-prop-types
      store: PropTypes.object.isRequired // eslint-disable-next-line camelcase

    });

    return hoistNonReactStatics_cjs$1(ReducerInjector, WrappedComponent);
  };
});
...
var checkKey = function checkKey(key) {
  return invariant_1(isString(key) && !isEmpty(key), '(app/utils...) injectSaga: Expected `key` to be a non empty string');
};
...
var checkDescriptor = function checkDescriptor(descriptor) {
  ...
  invariant_1(conformsTo(descriptor, shape), '(app/utils...) injectSaga: Expected a valid saga descriptor');
};
...
function injectSagaFactory(store, isValid) {
  return function injectSaga(key) {
    ...
    var newDescriptor = objectSpread({}, descriptor, {
    ...
    if (!hasSaga || hasSaga && mode !== DAEMON && mode !== ONCE_TILL_UNMOUNT) {
      ...
      store.injectedSagas[key] = objectSpread({}, newDescriptor, {
  ...
  return function (WrappedComponent) {
    ...
    function (_React$Component) {
      ...
      function InjectSaga() {
        ...
        _this = possibleConstructorReturn(this, (_getPrototypeOf2 = getPrototypeOf$1(InjectSaga)).call.apply(_getPrototypeOf2, [this].concat(args)));

        defineProperty(assertThisInitialized(assertThisInitialized(_this)), "injectors", getInjectors$1(_this.context.store));
    ...
    defineProperty(InjectSaga, "displayName", "withSaga(".concat(WrappedComponent.displayName || WrappedComponent.name || 'Component', ")"));
    ...
    return hoistNonReactStatics_cjs$1(InjectSaga, WrappedComponent);
  };
});
