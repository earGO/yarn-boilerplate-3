...
var id$1 = function id(_, _id) {
  return _id;
};

var getCatalogById = reselect.createSelector(stateSelector, id$1, function (catalogsList, id) {
...
var types$2 = {
  ...
  updateRow: function updateRow() {
    ...
    var _ref3 = args.payload || {},
        updatedRow = _ref3.updatedRow,
        catalogId = _ref3.catalogId;
