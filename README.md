...
|_packages
 ...
 в случае, если во время работы вы не трогали код самого приложения, и изменения вносились только в пакеты - из предлагаемой версии для ПРИЛОЖЕНИЯ выбирайте